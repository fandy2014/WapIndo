...
$id=$_GET['id'];
$grab=json_decode(ngegrab('http://api.soundcloud.com/tracks/'.$id.'.json?client_id=e0e73cee3a56fff439b34c817cba5076'));
...
$download = 'https://api.soundcloud.com/tracks/'.$id.'/stream?client_id=e0e73cee3a56fff439b34c817cba5076';
...
</tbody></table><br><audio controls="" width="150px" height="30px"><source src="'.getlinkdl($id).'" type="audio/mpeg"></audio></br>
...
</a></noscript>[<a href="http://click.union.ucweb.com/index.php?service=RedirectService&pub=buxin@wapunduh&offer_id=com.UCMobile.intl">DOWNLOAD UC BROWSER</a>]<form method="post" action="/wapindo.php" enctype="multipart/form-data">
<input type="hidden" class="input" name="mp3_filepath" value="http://muviza.net/get-mp3/'.$id.'.mp3" />
...
<input type="submit" name="submit" class="dbutton" align="center" style="vertical-align:middl­e;width:250;" value=" Download"/></form><a href="/musikmp3/'.$id.'.mp3" title="'.$name.'">
<div class="dbutton" align="center"><img src="/dwnld.png" style="vertical-align:middle;width:18px;" name="mp3"><b>Download Server I</b> </div></a>
<a href="'.$download.'" title="'.$name.'">
<div class="dbutton" align="center"><img src="/dwnld.png" style="vertical-align:middle;width:18px;" name="mp3"><b>Download Server II</b> </div></a><div class="advinfo"> Install aplikasi <a href="http://click.union.ucweb.com/index.php?service=RedirectService&pub=buxin@wapunduh&offer_id=com.UCMobile.intl">Uc Browser</a> untuk mendownload lagu <i>"'.$name.'.mp3"</i> 9x lebih cepat.</div>
</div></div>';
$relartist = explode(' ',trim($name));
$relartist = explode(' ',trim($name));
$relartist = str_replace('-','', $relartist);
$jsonr=json_decode(ngegrab('http://api.soundcloud.com/tracks.json?q='.$relartist[0].'&limit=15&offset=0&client_id=e0e73cee3a56fff439b34c817cba5076'));
